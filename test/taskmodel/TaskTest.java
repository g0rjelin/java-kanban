...
public class TaskTest {
    ...
    public void shouldTasksBeEqualWhenTheirIdEquals() {
        ...
        Task taskTwoWithId1 = new Task(1, "Task1 Equality Id Test (with changed fields)", "Description Equality Id Test (with changed fields)",
                TaskStatus.IN_PROGRESS, Duration.ofMinutes(50));

        //обратная проверка: все поля равны, только id отличается
        Task taskThreeWithId2 = new Task(2, "Task1 Equality Id Test", "Description Equality Id Test", TaskStatus.NEW, Duration.ofMinutes(30));
