...
public class EpicTest {
    ...
    public void shouldEpicsBeEqualWhenTheirIdEquals() {
        ...
        Epic epicOneWithId1 = new Epic(1, "Epic1 Equality Id Test", "Description Equality Id Test", subtaskIdList);
        //прямая проверка: id равные, при этом поля могут отличаться
        Epic epicTwoWithId1 = new Epic(1, "Epic1 Equality Id Test (with changed fields)", "Description Equality Id Test (with changed fields)", new ArrayList<>());

        //обратная проверка: все поля равны, только id отличается
        Epic epicThreeWithId2 = new Epic(2, "Epic1 Equality Id Test", "Description Equality Id Test", subtaskIdList);
